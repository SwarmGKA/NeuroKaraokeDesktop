...
const fallbackTranslations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'downloads.empty': '暂无下载的歌曲',
    'downloads.downloadNow': '去下载',
    'downloads.delete': '删除',
    'downloads.downloading': '下载中...',
    'downloads.downloaded': '已下载',
    'downloads.downloadFailed': '下载失败',
    'downloads.fileSize': '文件大小',
    'downloads.deleteConfirm': '确定要删除这首歌吗？',
    'downloads.showInFolder': '打开文件所在位置',
    'song.download': '下载',
    ...
    'playlist.backToList': '返回列表',
    'playlist.notFound': '歌单不存在',
    'playlist.playAll': '播放全部',
    'playlist.minutes': '分钟',
    'playlist.emptySongs': '歌单暂无歌曲',
  ...
  en: {
    ...
    'downloads.empty': 'No downloaded songs',
    ...
    'downloads.downloadFailed': 'Download failed',
    'downloads.fileSize': 'File size',
    'downloads.deleteConfirm': 'Are you sure you want to delete this song?',
